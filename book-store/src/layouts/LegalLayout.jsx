...
const LegalLayout = () => {
  const legalLinks = [
    ...
    { path: '/legal/shipping-info', name: 'Shipping Info' },
    { path: '/legal/returns-policy', name: 'Returns Policy' }
  ];
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-64 flex-shrink-0">
            <div className="sticky top-24 bg-white rounded-xl shadow-sm p-4">
              <h3 className="font-bold text-gray-800 mb-4 pb-2 border-b">Legal</h3>
